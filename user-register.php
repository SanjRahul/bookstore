<?php
 ...
 if (isset($_POST['registration'])){
   ...
   $check=mysqli_query($con, "SELECT * FROM user_register where user_email='$email'");
   if(mysqli_num_rows($check)>=1){
     ...
     if($email==$dbemail){
      ...
      $query="insert into user_register (user_name,user_email,password,confirm_password)values('$name','$email','$password','$confirmpassword')";
    ...
    <div class="register-box">
        <div class="card card-outline card-primary">
            ...
            <form action="" method="POST" id="regform">
                ...
                <input type="text" class="form-control" name="name" id="username" placeholder="Full Name" autofocus>
