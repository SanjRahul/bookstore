...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <!-- <img src="./dist/img/favicon_io/favicon-32x32.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./Book-Data.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Book</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="./Book-Add.php" class="btn btn-primary float-right">
                  Add Book
                </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                    ...
                    <td><img alt="Avatar" class="" style="width: 30px;" src="<?php echo $prod['book_image'];?>"></td>
                    <td><?php echo $prod['book_price'];?></td>
                    <td>
                    ...
                    <td>
                      ...
                      <a class="btn btn-info btn-sm" href="./Book-Edit.php?id=<?php echo $prod['book_id'] ?>">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                      </a>
                      <input type="hidden" class="delete_id_value" value="<?php echo $prod['book_id'] ?>">
...
<script>
  $(document).ready(function () {  
    $('#example1 tbody').on('click','.btn-danger',function (e) {
      e.preventDefault();
