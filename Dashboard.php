...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake brand-image img-circle elevation-3" src="./dist/img/favicon_io/favicon-32x32.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <?php 
        ...
        echo"<script>window.open('./login-store.php', '_self')</script>";
      }
