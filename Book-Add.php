...
if(isset($_POST['AddProduct'])){
  ...
  if(in_array($ext,$supported_image)){
    ...
    $q = "INSERT INTO books (store_email,book_name,book_price,book_image)values('$user_email','$product_name','$product_price','$destination_img')";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./Book-Add.php" class="nav-link active">
                ...
                <div class="card-body">
                  <p class="card-text">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="ProductName" id="formGroupExampleInput" placeholder="BOOK Name" required>
                    </div>
                    <div class="mb-3">
                      <label for="formGroupExampleInput2" class="form-label">Book Price</label>
                      <input type="text" class="form-control" name="ProductPrice" id="formGroupExampleInput2" placeholder="BOOK Price" required>
                    </div>
                    <div class="mb-3">
                      <label for="formGroupfileInput3" class="form-label">Book Image</label>
                      <input type="file" class="form-control" name="ProductImage" id="formGroupfileInput3" placeholder="BOOK Image" required>
                    </div>
                    
                  </p>
                  <input type="submit" class="btn btn-primary" name="AddProduct" value="Add Book">
                </div>
              </form>
            </div>
          </div>
